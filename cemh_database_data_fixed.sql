...
(1, 1, 1, 'admin', '管理员', '$2a$10$7JB720yubVSOfvVWbGRJremNB4AfT7aO2vJS7b9YETyWmrfDwdAJG', '13800138000', 'admin@cemh.org', 0, 0, 1, '系统管理员'),
(2, 1, 2, 'tech_admin', '技术主管', '$2a$10$7JB720yubVSOfvVWbGRJremNB4AfT7aO2vJS7b9YETyWmrfDwdAJG', '13800138001', 'tech@cemh.org', 0, 1, 1, '技术部门管理员'),
(3, 1, 5, 'developer', '开发工程师', '$2a$10$7JB720yubVSOfvVWbGRJremNB4AfT7aO2vJS7b9YETyWmrfDwdAJG', '13800138002', 'dev@cemh.org', 0, 1, 1, '软件开发工程师'),
(4, 1, 3, 'marketing', '市场专员', '$2a$10$7JB720yubVSOfvVWbGRJremNB4AfT7aO2vJS7b9YETyWmrfDwdAJG', '13800138003', 'market@cemh.org', 1, 1, 1, '市场营销专员'),
(5, 1, 4, 'hr_manager', '人事经理', '$2a$10$7JB720yubVSOfvVWbGRJremNB4AfT7aO2vJS7b9YETyWmrfDwdAJG', '13800138004', 'hr@cemh.org', 1, 1, 1, '人力资源经理'),
(6, 2, 7, 'test_admin', '测试管理员', '$2a$10$7JB720yubVSOfvVWbGRJremNB4AfT7aO2vJS7b9YETyWmrfDwdAJG', '13800138005', 'test@cemh.org', 0, 1, 1, '测试租户管理员'),
(7, 2, 8, 'test_user', '测试用户', '$2a$10$7JB720yubVSOfvVWbGRJremNB4AfT7aO2vJS7b9YETyWmrfDwdAJG', '13800138006', 'user@cemh.org', 2, 1, 1, '测试租户普通用户');
...
-- 10. 课程信息初始化数据
-- =============================================
INSERT INTO `course` (`id`, `tenant_id`, `course_code`, `course_name`, `description`, `instructor`, `duration`, `difficulty`, `price`, `max_students`, `current_students`, `view_count`, `rating`, `rating_count`, `status`, `is_free`, `is_hot`) VALUES
(1, 1, 'JAVA_001', 'Java基础编程', 'Java语言基础知识和编程技巧', '技术主管', 1200, 1, 0.00, 50, 12, 234, 4.5, 8, 1, 1, 1),
(2, 1, 'SPRING_001', 'Spring Boot实战', 'Spring Boot框架实战开发', '开发工程师', 1800, 2, 299.00, 30, 8, 156, 4.8, 5, 1, 0, 1),
(3, 1, 'VUE_001', 'Vue.js前端开发', 'Vue.js框架前端开发技术', '前端工程师', 1500, 2, 199.00, 40, 15, 189, 4.3, 12, 1, 0, 0),
(4, 1, 'MYSQL_001', 'MySQL数据库管理', 'MySQL数据库设计和管理', '数据库工程师', 900, 1, 0.00, 60, 25, 298, 4.6, 18, 1, 1, 1),
(5, 2, 'TEST_001', '软件测试基础', '软件测试理论和实践', '测试工程师', 600, 1, 0.00, 20, 5, 67, 4.2, 3, 1, 1, 0);

-- =============================================
-- 11. 学习记录初始化数据
-- =============================================
INSERT INTO `learning_record` (`user_id`, `course_id`, `enrollment_time`, `start_time`, `progress`, `study_duration`, `status`, `score`) VALUES
(3, 1, '2024-06-01 10:00:00', '2024-06-01 14:00:00', 85.50, 720, 1, NULL),
(3, 2, '2024-06-05 09:00:00', '2024-06-05 15:00:00', 45.30, 480, 1, NULL),
(4, 3, '2024-06-03 11:00:00', '2024-06-03 16:00:00', 92.80, 890, 2, 88.5),
(5, 4, '2024-06-02 08:00:00', '2024-06-02 13:00:00', 100.00, 900, 2, 95.0),
(2, 1, '2024-06-04 14:00:00', '2024-06-04 18:00:00', 78.20, 650, 1, NULL),
(7, 5, '2024-06-06 10:00:00', '2024-06-06 14:00:00', 65.40, 320, 1, NULL);
